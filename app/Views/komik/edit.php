        ...
        <div class="col-8">
            ...
            <form action="/komik/update/<?= $komik['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <img src="/img/<?= $komik['sampul']; ?>" class="img-thumbnail">
                    </div>
                    <div class="col-sm-8">
                        <input class="form-control form-control-sm <?= ($validation->hasError('sampul')) ? 'is-invalid' : ''; ?>" id="sampul" type="file" name="sampul">
                        <div class="invalid-feedback">
